    ...
    return(
        <div className="bg-gray-50">
            <div className="flex flex-col items-center px-5 container mx-auto py-[80px] ">
                <h2 className="text-3xl font-black text-brand-blue tracking-tighter">Our values</h2>
