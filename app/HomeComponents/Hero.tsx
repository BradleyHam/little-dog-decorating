...
export default function Hero() {
    ...
    useEffect(() => {
        gsap.to(headingRef.current, {opacity: 1, y: 0, duration: 1, delay: 0});
    }, []);
        ...
        <div className="hero-container h-screen">
            <div className="text-white px-5 flex flex-col items-start lg:items-center pt-[150px] lg:pt-[250px]">
                ...
                <div className="heading-row flex flex-col mx-auto pt-12 lg:pt-28 text-center mb-[40px]">
                    <h1 ref={headingRef} style={{opacity: 0, transform: 'translateY(100px)'}} className="text-4xl text-left lg:text-center text-brand-blue font-bold capitalize mb-4 tracking-tight leading-normal font-poppins text-white">
